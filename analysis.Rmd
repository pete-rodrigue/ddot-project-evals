...
DDOT has looked at a few projects in depth. But we can also use DC's crash data to look at every (or almost every) protected and buffered bike lane in DDOT's "bike lane" shapefile.

what we'll do:

* get an X meter buffer around every individual road segment
